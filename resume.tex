...
\name{Jonathan}{Monette}
\address{PO Box 181, Leander, TX, 78646}
\mobile{(956) 463-2864}

\email{jon.monette@gmail.com}
\homepage{www.jmoney.dev}
\medium{@jmoney8080}
\github{jmoney8080}
\linkedin{jmoney8080}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Principal Engineer} % Your expertise/fields

\makecvfooter{\today}{Jonathan Monette~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/licenses_certifications.tex}
